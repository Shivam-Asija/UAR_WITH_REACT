            ...
            <div className="container">
                <div className="row">
                    <div className="col-md-12 bg-light">
                        <img className="img-fluid d-block mt-3 pl-3 pt-4 pb-3" src={KpiLogo}  alt="kpi logo"/>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div className="row">
                                <div className="col-md-12 col-lg">
                                    {load && activePage === "Eclipse"? (
                                        <DoughnutChart pending={pending} change={change} approved={approved}/> 
                                        ) : ""
                                    }
                                    {load && activePage === "Tim"? (
                                        <DoughnutChart pending={pending} change={change} approved={approved}/> 
                                ...
                                <div className="col-md-12 col-lg text-center align-middle vertical-align-center">
                                    <div className="row h-auto p-3 m-2 rounded-0 text-light bg-success">
                                        ...
                                        <div className="col">
                                            <h3 className="m-0" style={{fontSize: "45px"}}>{approved > 0 ? approved : "0"}</h3>
                                            <h5 className="m-0"><b>Approved</b></h5>
                                        </div>
                                    </div>
                                    <div className="row h-auto p-3 m-2 rounded-0 text-light" style={{backgroundColor: "#00629B"}}>
                                        <div className="col my-auto">
                                            {/* <i className="material-icons" style={{fontSize: "55px"}>insert_chart_outlined</i> */}
                                        </div>
                                        <div className="col">
                                            <h3 className="m-0" style={{fontSize: "45px"}}>{change > 0 ? change : "0"}</h3>
                                            <h5 className="m-0"><b>Change Requests</b></h5>
                                        </div>
                                    </div>
                                    <div className="row h-auto p-3 m-2 rounded-0 text-light" style={{backgroundColor: "#787878"}}>
                                        <div className="col my-auto">
                                            <i className="material-icons" style={{fontSize: "55px"}}></i>
                                        </div>
                                        <div className="col"> 
                                            <h3 className="m-0" style={{fontSize: "45px"}}>{pending > 0 ? pending : "0"}</h3>
                                            <h5 className="m-0"><b>Pending Records</b></h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
