...
export default function Home() {
  ...
  const css = { cardCss, EclipseBtn, TimBtn };

  const cardData = {
    adminHeading: "ADMINISTARTION PORTAL",
    adminEclipseBtnRoute: "/EclipseAdminRequestsForChange",
    adminTimBtnRoute: "/TimAdminRequestsForChange",
    managerHeading: "MANAGER PORTAL",
    managerEclipseBtnRoute: "/EclipseManagerPending",
    managerTimBtnRoute: "/TimManagerPending",
  };
